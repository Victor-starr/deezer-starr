  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Explore popular playlists, artists, albums, and tracks with Deezer Starr. Listen to 30-second previews of your favorite music."
        />
        <meta
          name="keywords"
          content="Deezer, music, playlists, artists, albums, tracks, music player"
        />
