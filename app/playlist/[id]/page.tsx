...
export default async function PlaylistPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <>
      <Head>
        <title>{playlist.title} - Deezer Starr</title>
        <meta name="description" content={playlist.description || `Listen to ${playlist.title} with ${playlist.nb_tracks} tracks.`} />
        <meta name="keywords" content={`Deezer, playlist, ${playlist.title}, music`} />
      </Head>
